...
/* poe port active channel (when supplying power) */
typedef enum _sai_poe_port_active_channel_id_t
{
...
/* poe port signature type (when supplying power) */
typedef enum _sai_poe_port_signature_type_id_t
{
    SAI_POE_PORT_SIGNATURE_TYPE_SINGLE = 0,
    SAI_POE_PORT_SIGNATURE_TYPE_DUAL = 1
} sai_poe_port_signature_type_id_t;

/* poe port classification method (when supplying power) */
typedef enum _sai_poe_port_class_method_id_t
{
